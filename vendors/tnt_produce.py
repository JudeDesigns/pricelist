"""
TNT Produce Company Parser
Handles PDF parsing for TNT Produce Company price lists
...
class TNTProduceParser(BaseParser):
    """Parser for TNT Produce Company price lists"""
    
    def __init__(self):
        super().__init__()
        self.vendor_name = "TNT Produce Company"
        self.vendor_code = "tnt_produce"
    ...
    def validate_product_id(self, product_id):
        """
        Validate TNT Produce product ID format.
    ...
    def parse_table(self, table_data: List[List[str]]) -> List[Dict[str, str]]:
        """
        Parse table data from TNT Produce PDF.
    ...
    def parse_text_lines(self, text_lines: List[str]) -> List[Dict[str, str]]:
        """
        Parse text lines from TNT Produce PDF.
