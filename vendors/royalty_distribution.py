"""
Royalty Distribution Parser
Handles PDF parsing for Royalty Distribution price lists
...
class RoyaltyDistributionParser(BaseParser):
    """Parser for Royalty Distribution price lists"""
    
    def __init__(self):
        super().__init__()
        self.vendor_name = "Royalty Distribution"
        self.vendor_code = "royalty_distribution"
    ...
    def validate_product_id(self, product_id):
        """
        Validate Royalty Distribution product ID format.
    ...
    def parse_table(self, table_data: List[List[str]]) -> List[Dict[str, str]]:
        """
        Parse table data from Royalty Distribution PDF.
    ...
    def parse_text_lines(self, text_lines: List[str]) -> List[Dict[str, str]]:
        """
        Parse text lines from Royalty Distribution PDF.
