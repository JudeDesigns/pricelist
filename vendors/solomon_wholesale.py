"""
Solomon Wholesale Parser
Handles PDF price lists from Solomon Wholesale
"""

import re
from .base_parser import BaseParser

class SolomonWholesaleParser(BaseParser):
    def __init__(self):
        super().__init__()
        self.vendor_name = "Solomon Wholesale"
        self.vendor_code = "solomon_wholesale"
