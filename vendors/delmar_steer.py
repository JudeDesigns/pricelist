"""
Del Mar Distributions Steer Parser
Handles Del Mar Distributions Steer price list PDFs
"""

from .base_parser import BaseParser
import re

class DelMarSteerParser(BaseParser):
    def __init__(self):
        super().__init__()
        self.vendor_name = "Del Mar Distributions Steer"
        self.vendor_code = "delmar_steer"
    ...
    def parse_text_line(self, line):
        ...
        # Example: "STR-123 | BEEF TENDERLOIN | $15.99"
