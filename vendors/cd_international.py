"""
C&D International Fishery Parser
Handles PDF parsing for C&D International Fishery price lists
...
class CDInternationalParser(BaseParser):
    """Parser for C&D International Fishery price lists"""
    
    def __init__(self):
        super().__init__()
        self.vendor_name = "C&D International Fishery"
        self.vendor_code = "cd_international"
    ...
    def validate_product_id(self, product_id):
        """
        Validate C&D International product ID format.
    ...
    def parse_table(self, table_data: List[List[str]]) -> List[Dict[str, str]]:
        """
        Parse table data from C&D International PDF.
    ...
    def parse_text_lines(self, text_lines: List[str]) -> List[Dict[str, str]]:
        """
        Parse text lines from C&D International PDF.
