"""
Monarch Trading Parser
Handles PDF price lists from Monarch Trading
"""

import re
from .base_parser import BaseParser

class MonarchTradingParser(BaseParser):
    def __init__(self):
        super().__init__()
        self.vendor_name = "Monarch Trading"
        self.vendor_code = "monarch_trading"
